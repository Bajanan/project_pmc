    ...
    <section id="wrapper">
        ...
        <div id="page-content-wrapper" class="p-b-100">
			...
			<div class="row py-3 d1-bg ps-5 align-items-center">
                <div class="col-lg-12">
                    <h3 class="headingH3">View Company Return</h3>
                </div>
			</div>
 ...
 <!-- Page content -->
			...
			<table class="table-bordered mt-4" style="width:100%">
				<thead>
                    <tr>
                        <td>#</td>
                        <td class="fw-bold">{{ $company_return->CRN_No }}</td>
                    </tr>
                    <tr>
                        <td>Supplier</td>
                        <td class="fw-bold">{{ $company_return->Supplier->name }}</td>
                    </tr>
                    <tr>
                        <td>Date</td>
                        <td class="fw-bold">{{ $company_return->date }}</td>
                    </tr>
                    <tr>
                        <td>Reason</td>
                        <td class="fw-bold">{{ $company_return->reason }}</td>
                    </tr>
                    <tr>
                        <td>Notes</td>
                        <td class="fw-bold">{{ $company_return->notes ?? '-' }}</td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
				...
				<tbody>
                    @foreach ($company_return->stock  as $stock)
					<tr class="">
                ...
                <tfoot class="fw-bold">
                    ...
                    <tr>
                        <td>Total Qty</td>
                        <td>{{ $company_return->stock()->sum('qty') }}</td>
                    </tr>
                    <tr>
                        <td>Total Cost</td>
                        <td>{{ number_format($company_return->total_cost, 2) }}</td>
                    </tr>
                    <tr>
                        <td>User Added</td>
                        <td>{{ $company_return->getStaffMember()}}</td>
                    </tr>
                </tfoot>
			</table>
            </div>
